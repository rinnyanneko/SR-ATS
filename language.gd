...
func _ready() -> void:
	if cfg.get_value("System", "lang") == "en":sel = 0
	elif cfg.get_value("System", "lang") == "jp":sel = 1
	elif cfg.get_value("System", "lang") == "cmn":sel = 2
	elif cfg.get_value("System", "lang") == "zh":sel = 3
	else: sel = 0
